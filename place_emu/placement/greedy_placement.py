...
def place(network_file, service_files, sources_file):
    # read input
    ...
    service_file_list=service_files.split(",")
    ...
    for src in sources:
        ...
        for service_file in service_file_list:
            with open(service_file) as f:
                ...
                print(network.node[src_vnf['node']])
    ...
    result = writer.write_placement(network_file, service_files, sources_file, placement, 'greedy')
...
def parse_args():
    ...
    parser.add_argument("--network", help="Network input file (.graphml)", required=False, default="/home/xiaofu/placement-emulation/inputs/networks/Uran.graphml", dest="network")
    parser.add_argument("--service", help="Template input file (.yaml)", required=False, default="/home/xiaofu/placement-emulation/inputs/services/bridge1chain.yaml,/home/xiaofu/placement-emulation/inputs/services/bridge2chain.yaml", dest="service")
    parser.add_argument("--sources", help="Sources input file (.yaml)", required=False, default="/home/xiaofu/placement-emulation/inputs/sources/sources04.yaml", dest="sources")
